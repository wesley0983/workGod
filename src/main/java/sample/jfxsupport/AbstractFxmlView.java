...
public abstract class AbstractFxmlView implements ApplicationContextAware {
	...
	/**
	 * 獲取{@link FXMLView}annotation的檔案路徑
	 *
	...
	/**
	 * 獲取所有使用 {@link FXMLView}的annotation
	 *
	...
	private FXMLLoader loadSynchronously(final URL resource, final ResourceBundle bundle,
		...
		System.out.println("88888888888888"+resource +"   " +bundle);
	 ...
	 * @param controller
	 */
	public void setController(PrototypeController controller) {
